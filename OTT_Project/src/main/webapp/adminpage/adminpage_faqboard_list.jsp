...
<%
    ...
    ArrayList<BoardVO> list = dao.select(4);
%>  
<!DOCTYPE html>
<html>
<head>
	        ...
	        <section class="notice_list">
	            ...
	            <table border=1 class="notice_list">
	             ...
	             <tr>
	               ...
	               <form name="faqboard_delete_form" action="" method="get">
                       <% for(BoardVO vo : list){%>
                        <tr class="need_center">
                            <td><input type="checkbox" name="faq_delete_seleted" value=></td>
                            <td><%=vo.getRno() %></td>
                            <td><a href="http://localhost:9000/OTT_Project/adminpage/adminpage_faqboard_content.jsp?num=<%=vo.getNum()%>"><%=vo.getTitle()%></a></td>
                       ...
                       <tr class="need_right" >
                            <td colspan="6">
                                ...
                                <a href="http://localhost:9000/OTT_Project/adminpage/adminpage_faqboard_write.jsp">

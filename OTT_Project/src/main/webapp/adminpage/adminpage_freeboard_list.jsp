...
<%
    ...
    ArrayList<BoardVO> list = dao.select(2);
%>   
<!DOCTYPE html>
<html>
<head>
	        ...
	        <section class="notice_list">
	            ...
	            <table border=1 class="notice_list">
	                ...
	                <tr class="need_center">
	                    <td><input type="checkbox" name="freeboard_delete_seleted" value=></td>
	                    <td><%=vo.getRno() %></td>
	                    <td><a href="http://localhost:9000/OTT_Project/board/freeboard_content.jsp?num=<%=vo.getNum()%>"><%=vo.getTitle()%></a></td>
	               ...
	               <tr class="need_right" >
	                    <td colspan="7">
	                        ...
	                        <a href="http://localhost:9000/OTT_Project/adminpage/adminpage_freeboard_write.jsp">

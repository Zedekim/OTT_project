...
<%
   ...
   /*  System.out.println(vo.getId());
    ...
    if(result == 1){
        ...
        String url="http://localhost:9000/OTT_Project/adminpage/adminpage_questionboard_content.jsp?num="+vo.getBnum();
        response.sendRedirect(url);
        /*response.setHeader("Refresh", "0; URL=http://localhost:9000/OTT_Project/board/freeboard_content.jsp?num=b_4"); */
    }else{
        response.sendRedirect("adminpage_questionboard_content.jsp?write_result=fail");
    }

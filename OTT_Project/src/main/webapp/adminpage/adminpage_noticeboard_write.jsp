    ...
    <div class="content">
        ...
        <div class="notice_write">
	        <section class="notice_write">
	            <h1>공지사항-글쓰기</h1>
	            <form name="notice_write_Form" action="adminpage_noticeboard_write_proc.jsp" method="post">
	            <input type="hidden" name="nid" value=""> 
	                <table class="board_update_delete_write">
	                    <tr>
	                        <td>
	                            <input type="text" name="title" value="" id="noticeboard_write_title">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <textarea rows="10" cols="50" name="content" id="noticeboard_write_content"></textarea>                   
	                        </td>
	                    </tr>
	                    <tr>
	                        <td colspan="2">
	                            <button type="button" class="" onclick="noticeboard_write_FormCheck()">글쓰기</button>

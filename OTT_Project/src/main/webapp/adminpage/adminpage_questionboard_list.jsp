...
<%
    ...
    ArrayList<BoardVO> list = dao.select(3);
%> 
<!DOCTYPE html>
<html>
<head>
            ...
            <table border=1 class="notice_list">
             ...
             <tr>
                ...
                <tr class="need_center">
                    <td><input type="checkbox" name="question_seleted" value=""></td>
                    <td><%=vo.getRno() %></td>
                    <td><a href="http://localhost:9000/OTT_Project/adminpage/adminpage_questionboard_content.jsp?num=<%=vo.getNum()%>"><%=vo.getTitle()%></a></td>
                    <td>답변 미완료</td>
                     <td><%= vo.getDate() %></td>
                </tr>
                <% } %>
               <tr class="need_right" >
                    <td colspan="5">
                        ...
                        <a href="http://localhost:9000/OTT_Project/adminpage/adminpage_questionboard_write.jsp">

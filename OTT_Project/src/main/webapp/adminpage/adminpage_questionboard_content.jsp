        ...
        <div class="notice_content_total">
	        <section class="notice_content">
	            ...
	            <table border=1 class="notice_content cs_table">
	             ...
	             <!-- 밑에서 부터 댓글 추가 --> 
                <div>
                <form name="questionboard_commentForm" method="post" action="adminpage_questionboard_comment_write_proc.jsp" id="questionboard_commentForm">
                  ...
                  <table class="cs_comment comment_table" >
                         <tr>
                             ...
                             <td class="comment_text">
                                <textarea id = "adminpage_questionboard_commentText" style="height:50px;" class="form-control" placeholder="댓글을 입력해주세요." name="content"></textarea>
                             </td>

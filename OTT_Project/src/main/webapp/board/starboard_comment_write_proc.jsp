...
<%
   ...
   /*  System.out.println(vo.getId()); */
    ...
    int result = dao.reviewCommentinsert(vo);
    
    if(result == 1){
        //게시글 등록 완료
        /* session.setAttribute("sid", vo.getId()); */        
        String url="http://localhost:9000/OTT_Project/board/starboard_content.jsp?num="+vo.getBnum();
        response.sendRedirect(url);
        /*response.setHeader("Refresh", "0; URL=http://localhost:9000/OTT_Project/board/freeboard_content.jsp?num=b_4"); */
    }else{
        response.sendRedirect("starboard_content.jsp?write_result=fail");
    }

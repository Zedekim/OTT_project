        ...
        <section class="notice_list">
            ...
            <table border=1 class="notice_list">
                ...
                <tr>
                	<td><%=number--%></td>
                	<td>
                	<a href="http://localhost:9000/OTT_Project/board/noticeboard_content.jsp?num=<%=vo.getNum()%>"><%=vo.getTitle()%></a>
                    </td>
            ...
            <%
            		if(count > 0){
            			...
            			if(startPage > pageBlock){
            				%>
            				<a class ="link2" href="noticeboard_list.jsp?pageNum=<%=startPage - pageBlock %>">
            			...
            			for(int i=startPage; i <= endPage; i++){
            				...
            				if(i == currentPage){
            					...
            					%>
            					<a class ="link2" href="noticeboard_list.jsp?pageNum=<%=i%>">
